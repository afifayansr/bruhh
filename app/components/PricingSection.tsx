                ...
                <div className="text-center mb-6 sm:mb-8">
                  <div className="mb-4 sm:mb-6">
                    {(plan as any).comingSoon ? (
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-yellow-100 dark:bg-yellow-500/20 border border-yellow-400/40">
                        <span className="text-xl sm:text-2xl orbitron-font font-bold text-yellow-600 dark:text-yellow-400">Coming Soon</span>
                      </div>
                    ) : (
                      <>
