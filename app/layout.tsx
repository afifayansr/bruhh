...
export const metadata: Metadata = {
  title: {
    default: "PieCore - Game Hosting, VPS & Dedicated Servers",
    template: "%s | PieCore"
  },
  description: "Premium game hosting, VPS & dedicated servers by PieCore. High-performance infrastructure with 99.9% uptime, DDoS protection & 24/7 support.",
  keywords: [
    "game hosting",
    "minecraft hosting",
    "discord bot hosting",
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://piecore.xyz",
    siteName: "PieCore - Game Hosting & Servers",
    title: "PieCore - Game Hosting, VPS & Dedicated Servers",
    ...
    images: [
      {
        url: "https://piecore.xyz/meta/Banner.png",
        width: 1200,
        height: 630,
        alt: "PieCore - Game Hosting, VPS & Dedicated Servers",
        type: "image/png"
      }
    ]
  },
  twitter: {
    ...
    images: ["https://piecore.xyz/meta/Banner.png"]
  },
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: "https://piecore.xyz"
  },
  other: {
    "msapplication-TileColor": "#1e40af",
    "msapplication-config": "/browserconfig.xml",
    "terms-of-service": "https://piecore.xyz/terms-of-services",
    "privacy-policy": "https://piecore.xyz/privacy-policy"
  }
};
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="PieCore" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "PieCore",
              "url": "https://piecore.xyz",
              "logo": "https://piecore.xyz/meta/Logo.png",
              ...
              "termsOfService": "https://piecore.xyz/terms-of-services",
              "privacyPolicy": "https://piecore.xyz/privacy-policy"
            })
          }}
        />
      </head>
